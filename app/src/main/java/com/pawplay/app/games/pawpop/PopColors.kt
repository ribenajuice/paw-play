...
internal val PopPeach = Color(0xFFFF9A76)       // the ship's glow while a lost paw's grace window runs
internal val PopBankWhite = Color.White         // the cloud bank's fill (at 38%) and edge (at 90%)
